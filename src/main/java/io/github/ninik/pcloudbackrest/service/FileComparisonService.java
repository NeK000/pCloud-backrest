...
public final class FileComparisonService {
    private static final long TIMESTAMP_TOLERANCE_MILLIS = 2_000L;

    public boolean shouldTransfer(Path localFile, RemoteFileEntry remoteFile, Optional<String> remoteSha1) throws IOException {
    ...
    public String sha1(Path file) throws IOException {
        try {
